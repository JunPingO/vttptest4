import { Restaurant, Comment, RestaurantwithMap } from './models'
...
export class RestaurantService {
	...
	public getRestaurant(restaurant: string): Promise<Restaurant> {
		// Implememntation in here
		return firstValueFrom<any>(this.http.get(`/api/${restaurant}/details`));
	}

	public getMapURL(restaurant: string): Promise<any> {
		return firstValueFrom<any>(this.http.get(`/api/${restaurant}/mapurl`));
	}
